...
class _SetupAccountScreenState extends State<SetupAccountScreen> {
  ...
  final List<String> _salonTypes = ['Unisex', 'Men\'s Salon', 'Women\'s Salon', 'Spa & Salon'];
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Padding(
            padding: const EdgeInsets.only(left: 38.0, right: 38.0, top: 10.0, bottom: 38.0),
            child: Form(
              key: _formKey,
              child: Column(
                    ...
                    child: ClipRRect(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Center(child: Icon(Icons.location_pin, size: 40, color: Colors.red[700])),
                        ],
                      ),
                    ),
                  ),
